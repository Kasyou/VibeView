...
func TestNineTools(t *testing.T) {
	s := &Server{client: nil, serverURL: "http://localhost:51820"}
	...
	expected := []string{"preview_reload", "preview_console", "preview_screenshot", "preview_inspect", "preview_diff", "preview_show", "preview_clear", "preview_history", "preview_stop"}
